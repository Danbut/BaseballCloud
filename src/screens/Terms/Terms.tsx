  ...
  >
    <Box height="100%" padding="15px" display="block">
      ...
      >
        ...
        <p>Last updated May 09, 2018</p>
        <p>
          Please read these Terms and Conditions (&quot;Terms&quot;, &quot;Terms
          and Conditions&quot;) carefully before using the{' '}
          <a href="[http://www.baseballcloud.com](http://www.baseballcloud.com/)">
            http://www.baseballcloud.com
          </a>{' '}
          website (the &quot;Service&quot;) operated by DaTraks LLC
          (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;).
        </p>
        <p>
        ...
        <p>
          ...
          governed by rules that are separate from these Terms Conditions. If
        ...
        <p>
          ...
          renew under the exact same conditions unless you cancel it or DaTraks
          LLC cancels it. You may cancel your Subscription renewal either
          through your online account management page or by contacting DaTraks
        ...
        <p>
          ...
          DaTraks LLC with accurate and complete billing information including
          ...
          you automatically authorize DaTraks LLC to charge all Subscription
          fees incurred through your account to any such payment instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any reason, DaTraks LLC
        ...
        <h3>Free Trial</h3>
        <p>
          DaTraks LLC may, at its sole discretion, offer a Subscription with a
        ...
        <p>
          ...
          Trial, you will not be charged by DaTraks LLC until the Free Trial has
        ...
        <p>
          At any time and without notice, DaTraks LLC reserves the right to (i)
          modify the terms and conditions of the Free Trial offer, or (ii)
          cancel such Free Trial offer.
        </p>
        <h3>Fee Changes</h3>
        <p>
          DaTraks LLC, in its sole discretion and at any time, may modify the
        ...
        <p>
          DaTraks LLC will provide you with a reasonable prior notice of any
        ...
        <h3>Refunds</h3>
        <p>
          Certain refund requests for Subscriptions may be considered by DaTraks
          LLC on a case-by-case basis and granted in sole discretion of DaTraks
          LLC.
        </p>
        <h3>Content</h3>
        <p>
        ...
        <p>
          DaTraks LLC has the right but not the obligation to monitor and edit
          all Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of DaTraks LLC or used with permission. You may not distribute,
        ...
        <p>
          ...
          to [support@baseballcloud.com](mailto:support@baseballcloud.com), with
        ...
        <p>
          ...
          [support@baseballcloud.com](mailto:support@baseballcloud.com)
        </p>
        <h3>Intellectual Property</h3>
        <p>
          The Service and its original content (excluding Content provided by
          users), features and functionality are and will remain the exclusive
          property of DaTraks LLC and its licensors. The Service is protected by
          ...
          consent of DaTraks LLC.
        </p>
        <h3>Links To Other Web Sites</h3>
        <p>
          Our Service may contain links to third party web sites or services
          that are not owned or controlled by DaTraks LLC
        </p>
        <p>
          DaTraks LLC has no control over, and assumes no responsibility for the
        ...
        <p>
          You acknowledge and agree that DaTraks LLC shall not be responsible or
        ...
        <p>
          You agree to defend, indemnify and hold harmless DaTraks LLC and its
        ...
        <p>
          In no event shall DaTraks LLC, nor its directors, employees, partners,
        ...
        <p>
          DaTraks LLC its subsidiaries, affiliates, and its licensors do not
